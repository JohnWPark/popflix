  ...
  var Auth = {
    ...
    register: function(user) {
      return auth.$createUser({email: user.email, password: user.password})
        .then(function() {
          //authentication so we have permission to write to Firebase
          return Auth.login(user);
      })
      .then(function(data) {
        //stores user data in Firebase after creating an account
...
//This function allows for the use of a gravatar
